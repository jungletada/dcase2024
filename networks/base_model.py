...
class BaseModel(object):
    def __init__(self, args, train, test):
        ...
        format_name = f'{self.args.model}_{self.args.dataset}{self.model_name_suffix}{self.eval_suffix}_seed{self.args.seed}'
        base_name = f"{self.export_dir}/{format_name}"
        ...
        self.model_path = self.model_dir/f"{format_name}.pth"
        self.score_distr_file_path = self.model_dir/f"score_distr_{format_name}.pickle"
        self.history_img = self.model_dir/f"history_{format_name}.png"
